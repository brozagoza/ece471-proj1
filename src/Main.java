...
public class Main {
	...
	final static String pstr2 = "MDULAZMUEDQFGDZUZSVGZU"
			...
			+ "QMEAZMXAZSIUFTDQPETUDFEQZUADNDMZPAZPMIWUZEITATMEEFMDFUZSQJBQDUQZOQGZ"
			+ "XUWQMXAFARNMOWGBCGMDFQDNMOWE";
	...
	public static void main(String[] args) {
		...
		cracker.run(strGud(pstr4));
		
	} // end main
	
	public static String strGud(String s) {
