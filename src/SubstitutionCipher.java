...
//		
//		int[] engOrder = new int[ALPHABET_COUNT];
//		int[] subOrder = new int[ALPHABET_COUNT];
...
//			engOrder[i] = tempMaxEng;
//			subOrder[i] = tempMaxSub;
		...
		while(scanner.hasNextLine())
		{
			...
			else
			{
				...
				else 
				{
					...
					System.out.println("Please enter another pair or enter 'quit' to exit  and print to 'output.txt':");
				}
			}
